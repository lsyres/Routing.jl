...
function prepare_return_values!(labels::Vector{Label}, max_neg_cost_routes::Int)
    if isempty(labels)
...
function bidirectional(org_pg::ESPPRC_Instance; max_neg_cost_routes=MAX_INT::Int, DSSR=false)
