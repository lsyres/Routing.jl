...
private:
    ...
    int bounding_counter, tmp_counter1, tmp_counter2;
...
public:
    Graph G;
    Espprc(int n, int start, int end, int step, int lt, int ut, int max_capacity, std::vector< std::vector<int> >& data, std::vector<double>& dual_var);

    void print_para();
    std::vector<int> espprc();
};
